...
const Hero: React.FC<HeroDocument> = (props) => {
  const { title, description, buttonLinkSlug, buttonText, image } = props;
  const heroItem = mapSanityDocumentToPersonalizableItem(props);

  useBehaviorTracking(heroItem.intentTag || {});
